...
function Aircon({ongetindex}){
    ...
    let img1 ="https://res.cloudinary.com/dmfs6il6m/image/upload/v1760004234/airconditionerimg/xymr8wtvdidmn8qbj00h.jpg"
    let img2 ="https://res.cloudinary.com/dmfs6il6m/image/upload/v1762429474/electronic-store-product-gallery-image-1-400x399_bkx8m1.jpg"
    let img3 ="https://res.cloudinary.com/dmfs6il6m/image/upload/v1762429474/electronic-store-product-gallery-image-34-150x150_ujuusd.jpg"
    let img4 ="https://res.cloudinary.com/dmfs6il6m/image/upload/v1762429474/electronic-store-product-gallery-image-28-150x150_hulqg7.jpg"
    ...
    return(
        ...
        <div className="grid grid-cols-1 lg:gap-10 lg:grid-cols-2 p-5 ">
            ...
            <div>
                <p className="text-sm mt-5 text-gray-500 pt-2 lg:text-[16px]">Home / Air Conditioner /Air Conditioner 5000 BTU, Efficient Cooling for Smaller Areas Like Bedrooms and Guest Rooms</p>
                <h1 className="text-xl font-semibold pt-3 lg:text-[27px] lg:pb-5">Air Conditioner 5000 BTU, Efficient Cooling for Smaller Areas Like Bedrooms and Guest Rooms</h1>
                ...
                <p className="lg:text-[18px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi sollicitudin consequat justo in cursus. Proin non velit quam. Etiam diam turpis, elementum in gravida maximus, efficitur quis nulla. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus sit amet interdum lorem. Mauris elementum justo id ante ornare consectetur.</p>
                 ...
                 <div>
                  <button onClick={()=>{ongetindex(0,"aircon")}} className="bg-black text-white py-1 px-4 ">Add to Cart</button>
                 </div>
                 </div>
