...
function Owen({ongetindex}){
    ...
    let img1 ="https://res.cloudinary.com/dmfs6il6m/image/upload/v1760368260/Kitchenappliances/f9vz5a7alu4hbosesqqb.jpg"
    let img2 ="https://res.cloudinary.com/dmfs6il6m/image/upload/v1762431142/electronic-store-product-gallery-image-13-400x400_szjvpc.jpg"
    let img3 ="https://res.cloudinary.com/dmfs6il6m/image/upload/v1762431141/electronic-store-product-gallery-image-9-150x150_bw9z2q.jpg"
    let img4 ="https://res.cloudinary.com/dmfs6il6m/image/upload/v1762431141/electronic-store-product-gallery-image-7-150x150_vjozhj.jpg"
    ...
    return(
        ...
        <div className="grid grid-cols-1 lg:gap-10 lg:grid-cols-2 p-5 ">
            ...
            <div>
                <p className="text-sm mt-5 text-gray-500 pt-2 lg:text-[16px]">Home / Kitchen Appliances /0.9 Cubic Feet Capacity 900 Watts Kitchen Essentials for the Countertop Stainless Steel</p>
                ...
                <p className="lg:text-[18px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi sollicitudin consequat justo in cursus. Proin non velit quam. Etiam diam turpis, elementum in gravida maximus, efficitur quis nulla. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus sit amet interdum lorem. Mauris elementum justo id ante ornare consectetur.</p>
                 ...
                 <div>
                  <button onClick={()=>{ongetindex(0,"kitchen")}} className="bg-black text-white py-1 px-4 ">Add to Cart</button>
                 </div>
                 </div>
