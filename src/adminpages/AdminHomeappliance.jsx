...
function AdminHomeappliances() {
    ...
    function onsubmit() {
        axios.post("http://localhost:5000/submithomeapppliance",{ value: productlist })
    }
    console.log(typeof(productlist.rating))

    return (
        <div>
            <h1>Home appliances Product</h1>
...
export default AdminHomeappliances